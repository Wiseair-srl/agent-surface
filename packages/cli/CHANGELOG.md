...
- Updated dependencies
  ...
  - @agent-surface/compiler@0.24.0

## 0.23.0

### Minor Changes

- 4095574: Align inspection wording and policy coverage presentation with `orpc-agent`.

### Patch Changes

- Updated dependencies [4095574]
  - @agent-surface/compiler@0.23.0
...
- 7e10e82: Restore the version lockstep, and gate it in CI so it cannot break silently again.
...
- Updated dependencies [7e10e82]
  - @agent-surface/compiler@0.22.0
  - @agent-surface/core@0.22.0

## 0.21.0

### Minor Changes

- a848094: Uniform the CLI with orpc-agent and add `--verbosity`.
